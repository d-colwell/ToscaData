...
{
    [ConvertedType(typeof(XTestStepValue))]
    internal class XTestStepValueConverter : ConverterBase<XTestStepValue>
    {
        ...
        protected override void PopulateProperties(XTestStepValue from, ReportableObject to)
        {
            ...
            properties.Add(new Property { Name = nameof(from.ActionProperty), Value = from.ActionProperty});
        ...
        protected override void PopulateLinks(XTestStepValue from, ReportableObject to)
        {
            //issues

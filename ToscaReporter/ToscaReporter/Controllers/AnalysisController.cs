...
namespace ToscaReporter.Controllers
{
    ...
    public class AnalysisController : ApiController
    {
        ...
        private readonly MongoDB.Driver.IMongoCollection<ReportableObject> _reportableObjects;
        ...
        public AnalysisController()
        {
            ...
            _reportableObjects = _db.GetCollection<ReportableObject>("reportable_objects");
        }
